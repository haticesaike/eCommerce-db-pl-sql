create or replace package p_user_operations as
  -- user kayit
...
create or replace package body p_user_operations as
-- kayit ekle
procedure register_user(p_first_name t_users.first_name%type,
                          p_last_name  t_users.last_name%type,
                          p_email      t_users.email%type,
...
begin
-- eposta kontrolu, eger gelen eposta daha once kayitliysa hata mesaji veriyor
